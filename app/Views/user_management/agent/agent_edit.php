                            ...
                            <div class="card-body px-5">
                                <form class="form form-horizontal"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="user_name" name="user_name" class="form-control"
                                                    value="<?= esc($agent['user_name']) ?>" required>
                                            </div>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" class="form-control"
                                                    value="<?= esc($agent['gender'] == 0 ? '남자' : '여자') ?>" disabled>
                                            </div>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="phone-number" name="phone" class="form-control"
                                                    value="<?= esc($agent['phone']) ?>" required>
                                            </div>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" class="form-control" name="user_id"
                                                    value="<?= esc($agent['user_id']) ?>" disabled>
                                            </div>
                                            ...
                                            <?php 
                                                $emailParts = explode('@', $agent['email']);
                                            ...
                                            <div class="col-md-8 form-group pe-0">
                                                <input type="text" class="form-control" id="sample6_postcode"
                                                    name="postcode" value="<?= esc($agent['postcode']) ?>" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <textarea id="notes" name="notes" class="form-control"
                                                    style="height: 115px; resize:none; overflow:auto;"><?= esc($agent['notes']) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-center mt-4 gap-3" style="height:45px">
                                        <a href="<?= base_url('user-management/agent/agent-detail/'.esc($agent['member_code'])) ?>?ref_menu=agent&ref=agent-list"
