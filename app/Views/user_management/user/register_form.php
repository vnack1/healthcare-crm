...
<div id="main">
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header d-flex">
                            <h4 class="card-title pe-3">회원 정보 입력</h4>
                            <h6 class="fw-light d-flex align-items-center"><span class="text-danger">*</span> 표시는 반드시
                                입력하셔야 하는 항목입니다</h6>
                        </div>
                        <div class="card-content">
                            <div class="card-body px-5">
                                <form method="POST" action="<?php echo base_url('user-management/user/enroll'); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group pt-2">
                                                <div class="form-check mb-1 d-flex justify-content-between">
                                                    ...
                                                    <button type="button" class="btn btn-link p-0 ms-2 terms-button"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (document.referrer.includes("user/enroll") && successMessage) {
                Swal.fire({
                    icon: "success",
                    title: "성공",
                    text: successMessage,
            ...
            if (document.referrer.includes("user/enroll") && errorMessage) {
                Swal.fire({
                    icon: "error",
                    title: "실패",
                    text: errorMessage,
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            submitButton.addEventListener("click", function(e) {
                ...
                // 유효성 검사 수행
                const nameValid = nameInput.value.trim() && nameMessage.classList.contains(
                    "text-success");
                const genderValid = checkGenderValidity();
                const birthDateValid = birthDateInput.value.trim() && birthDateMessage.classList
                    .contains(
                        "text-success");
                const domainValue = customDomainInput ? customDomainInput.value.trim() : domainSelect.value
                    .trim();
