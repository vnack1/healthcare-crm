                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <a href="/user-management/user/list" class="btn btn-primary px-4">회원 조회</a>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table table-bordered text-center mb-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php if (isset($distributerCount)): ?>
                                                <p><?= $distributerCount ?> 명</p>
                                                <?php endif; ?>
                                            </td>
                                            <td><?php if (isset($agentCount)): ?>
                                                <p> <?= $agentCount ?> 명</p>
                                                <?php endif; ?>
                                            </td>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <a href="/user-management/user/recent">
                                                            <div class="d-flex">
                                                                <div>더보기</div>
