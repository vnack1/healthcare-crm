...
<div id="main">
                            ...
                            <div class="card-body px-5">
                                <form class="form form-horizontal"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="user_name" name="user_name" class="form-control"
                                                    value="<?= esc($distributer['user_name']) ?>" required>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="phone-number" name="phone" class="form-control"
                                                    value="<?= esc($distributer['phone']) ?>" required>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" class="form-control" name="user_id"
                                                    value="<?= esc($distributer['user_id']) ?>" required readonly>
                                            </div>
                                            ...
                                            <?php 
                                                $emailParts = explode('@', $distributer['email']);
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" class="form-control" id="sample6_detailAddress"
                                                    name="address_detail"
                                                    value="<?= esc($distributer['address_detail']) ?>"
                                            ...
                                            <div class="col-md-10 form-group">
                                                <textarea id="notes" name="notes" class="form-control"
                                                    style="height: 115px; resize: none; overflow:auto;"><?= esc($distributer['notes']) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-center mt-4 gap-3" style="height:45px">
                                        <a href="<?= base_url('user-management/distributer/distributer-detail/'.esc($distributer['member_code'])) ?>?ref_menu=distributer&ref=distributer-list"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        passwordMessage.className = "password-message text-danger mt-1";
