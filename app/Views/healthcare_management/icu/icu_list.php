...
<div id="main">
            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        양자파동기를 사용하고 있는 회원의 상세 조회 및 검색이 가능합니다</p>
                </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal"
                                    action="<?php echo base_url('healthcare_management/icu/iculist') ?>" method="GET">
                                    <div class="form-body px-5">
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-1 form-group">
                                                <label class="pt-2">진행 회차 </label>
                                            </div>
                                            <div class="col-md-5 form-group">
                                                <select class="form-select" id="progress_time" name="progress_time">
                                                    <option value="">회차 선택</option>
                                                    <option value="0">0회차</option>
                            ...
                            <table class="table table-hover" id="s-member-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="clickable-row"
                                        data-url="<?= base_url('/healthcare_management/icu/icu-detail/' . esc($icuUser['member_code'])) ?>?ref_icu=all"
                                        ...
                                        <td class="text-center">
                                            <?= isset($icuUser['test_date']) ? esc($icuUser['test_date']) : '미등록' ?>
                                        </td>
                                        <td class="text-center">
                                            <?= isset($icuUser['progress_time']) && is_numeric($icuUser['progress_time']) ? esc($icuUser['progress_time']) . '회차' : '0회차' ?>
                                        </td>
                                    </tr>
                                    </tr>
                                    <?php endforeach; ?>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("check_date").value = urlParams.get("test_date") || "";
        document.getElementById("progress_time").value = urlParams.get("progress_time") || "";
        // 성별 라디오 버튼 설정
