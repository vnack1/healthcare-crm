                            ...
                            <table class="table table-hover" id="m-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="clickable-row"
                                        data-url="<?= base_url('melosira-management/melosira-detail/' . esc($item['user_idx'])) ?>?ref=complete"
                                        ...
                                        <td class="text-center">
                                            <?= $item['start_date'] ? esc($item['start_date']) : '정보 없음' ?></td>
                                        <td class="text-center">
                                            <?= $item['week_progress'] ? esc($item['week_progress']) . '주차' : '정보 없음' ?>
                                        </td>
                                        <td class="text-center">
                                            <?= isset($item['frequency']) ? "주{$item['frequency']}회" : '정보 없음' ?></td>
                                        <td class="text-center">
                                            <?php
